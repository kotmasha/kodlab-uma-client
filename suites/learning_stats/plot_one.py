...
ax_imps.plot(t,diff_raw,'-r',alpha=1,label='Raw imps difference')
ax_imps.plot(t,diff_full,'-b',alpha=1,label='Full imps difference')
ax_imps.legend()
