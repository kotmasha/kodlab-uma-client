...
def start_experiment(stdscr,env_length,burn_in,agent_to_examine,delay_string):
    ...
    EX = Experiment("UMA_Q2", UMARestService('localhost', '8000'))
    id_dec='decision'
    ...
    def print_state(banner_text,reported_data,id_agent):
        ...
        elapsed_time=ex_report['experiment']['exiting_update_cycle']-ex_report['experiment']['entering_update_cycle']
...
def main():
    curses.wrapper(start_experiment,10,200,'rt','nodelay')
